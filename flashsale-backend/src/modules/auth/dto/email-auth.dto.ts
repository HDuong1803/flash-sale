...
export class VerifyOtpDto {
  @ApiProperty({ description: 'Email cần xác minh', example: 'user@example.com', required: true })
  @IsEmail({}, { message: 'Email không hợp lệ' })
  email: string

  @ApiProperty({ description: 'Mã OTP 6 chữ số', example: '123456', required: true })
  @IsString()
...
export class ResendOtpDto {
  @ApiProperty({ description: 'Email cần gửi lại OTP', example: 'user@example.com', required: true })
  @IsEmail({}, { message: 'Email không hợp lệ' })
  email: string
}
