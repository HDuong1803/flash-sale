...
export default function AdminMerchantsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <h1 className="text-white text-2xl font-bold">Quản lý nhà bán hàng</h1>
      ...
      <ConfirmDialog
        open={!!confirmApprove}
        title="Duyệt nhà bán hàng?"
        description="Nhà bán hàng sẽ được phép tạo chiến dịch Flash Sale."
        confirmLabel="Duyệt"
        cancelLabel="Hủy"
